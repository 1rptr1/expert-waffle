#!/usr/bin/env python3
"""
Complete AI Dubber pipeline demo with real Hindi TTS
"""
import os
import sys
...
def main():
    ...
    print("🎬 Starting Complete AI Dubber with Hindi TTS...")
    ...
    print("🌍🎙️ Steps 3 & 4: Translating to Hindi and generating voice...")
    voice_files = []
    ...
    if voice_files:
        ...
        # Mix with original audio using fixed mixer
    ...
    output_video = os.path.join(output_dir, "dubbed_video_hindi.mp4")
    render_video(video_file, mixed_audio, output_video)
    
    print(f"🎉 Complete! Hindi dubbed video saved to: {output_video}")
